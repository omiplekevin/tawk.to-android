...
class UserProfileCacheMapper @Inject constructor() : EntityMapper<UserProfileCacheEntity, UserProfileModel> {


    override fun mapFromEntity(entity: UserProfileCacheEntity): UserProfileModel {
    ...
    override fun mapToEntity(domainModel: UserProfileModel): UserProfileCacheEntity {
        return UserProfileCacheEntity(
            id = domainModel.id,
